<div class="max-w-md mx-auto">
        ...
        <div class="flex flex-inline">
                <button id="btn_edit_profile" class="user-edit cursor-pointer w-1/3 bg-indigo hover:bg-indigo-dark text-white font-normal text-sm py-1 px-2 rounded" data-id="<?= $this->user_data['user']['id'] ?>">Izmeni</button>
        </div>
    </div>
...
<div class="hidden modal" id="editProfileModal">
        <div class="fixed pin z-50 overflow-auto bg-smoke-light flex">
            <div id="modal-content" class="relative p-4 sm:p-8 bg-white w-full max-w-md m-auto flex-col flex rounded shadow">
                ...
                <div id="edit_profile_modal_body">
                </div>
            </div>
        </div>
</div>