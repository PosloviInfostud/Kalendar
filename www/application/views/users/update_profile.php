<form id="update_profile" class="mt-4">
    <h2 class="pl-2 font-normal text-lg xs:text-xl sm:text-2xl border-l-4 mb-8 border-primary">Izmeni podatke</h2>
    ...
    <button type="submit" class="w-full mr-2 bg-primary hover:bg-indogo-dark text-white font-bold py-3 px-4 rounded">Ažuriraj</button>
</form>