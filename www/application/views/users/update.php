<form id="update_user" class="mt-4">
    <h2 class="pl-2 font-normal text-lg xs:text-xl sm:text-2xl border-l-4 mb-8 border-indigo">Update User</h2>
    ...
    <div class="mt-2 mb-8">
        <div class="sm:flex">
            ...
            <div class="sm:w-2/3 sm:flex sm:flex-inline sm:items-center mt-4 sm:mt-0">
                <label for="Role" class="text-lg">Account Status</label>
