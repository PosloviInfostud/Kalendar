...
<div>
    <button id="show_calendar" class="bg-grey hover:bg-grey-dark text-grey-darker hover:text-grey-darkest mb-4 py-3 w-full shadow rounded focus:outline-none">Raspored sastanaka za izabranu salu</button>
    ...
    <div class="bg-white border-x sm:border-y sm:rounded shadow px-4 py-8 sm:p-8">
        ...
        <form>
            <div class="mb-4">
                <p class="mb-2">Kada će se sastanak odviti?</p>
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="sm:flex items-center mb-2 sm:mb-0 sm:flex-1">
                        ...
                        <span class="sm:ml-1 text-xs text-grey-dark uppercase">osoba</span>
                    </div>
                </div>
            </div>
            <div class="mt-6 sm:mt-8 mb-4">
                <p class="mb-2">Učestalost</p>
            ...
            <button class="reservation_room_submit_by_room sm:hidden cursor-pointer w-full bg-primary hover:bg-primary-dark text-white font-bold uppercase py-3 px-4 mt-8 border border-primary shadow rounded focus:outline-none">Rezerviši</button>
        </form>
    </div>
    <!-- Submit button for desktop view -->
    <button class="reservation_room_submit_by_room hidden sm:block cursor-pointer w-full bg-primary hover:bg-primary-dark text-white font-bold uppercase py-3 px-4 mt-4 border border-primary shadow rounded focus:outline-none">Rezerviši</button>
</div>
...
<div class="hidden modal" id="room_reservation_modal">
    ...
    <div id="modal-content" class="p-8 bg-white w-full max-w-sm m-auto flex-col flex rounded shadow">
            <h1 class="pl-2 text-2xl sm:text-3xl border-l-6 mb-4 border-red">Potvrdite rezervaciju</h1>
            <div id="modal-body" class="my-4"></div>
            <div class="flex flex-inline justify-between">
                <button type="button" class="bg-red hover:bg-red-dark text-white font-medium w-full py-2 mt-2 mr-2 border border-red-light rounded focus:outline-none" id="reservation_room_submit_by_room_modal-btn-yes">Potvrdi</button>
                <button type="button" class="bg-grey hover:bg-grey-dark text-grey-darker font-medium w-full py-2 mt-2 ml-2 border border-grey rounded focus:outline-none" id="reservation_room_submit_by_room_modal-btn-no">Otkaži</button>
            </div>
        </div>
    </div>
</div> 
