<h3 class="pl-2 py-1 font-light text-lg sm:text-xl border-l-4 mb-6 border-primary">Izmeni ulogu koju ima <?= $name ?> za ovaj sastanak.</h3>
<form id="update_user_role_form">
    <div class="flex">
        <select class="w-full p-2 my-2 bg-grey-lighter border rounded" name="active" id="select_role">
            ...
            <option value="2" <?php if($role_id == 2): ?> selected="selected"<?php endif; ?>>Član</option>
        </select>        
    </div>
