<div class="jumbotron">
    <form id="reservation_equip_form" class="border border-warning rounded p-3" action="/reservations/submit_reservation_equip_form" method="POST">
        ...
        <div class="form-group">
            <p>When?</p>
            <p>from
                <input type="text" name="start_time" id="item_datetime_start" placeholder="start datetime" class="text-center">
                <small id="start_time_err" class="form-text text-danger error_box"></small>
                to
                <input type="text" name="end_time" id="item_datetime_end" placeholder="end datetime" class="text-center">
