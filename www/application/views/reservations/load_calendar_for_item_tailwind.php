...
<div>
    <button id="show_calendar" class="bg-grey hover:bg-grey-dark text-grey-darker hover:text-grey-darkest mb-4 py-3 w-full shadow rounded focus:outline-none">Raspored rezervacija za odabranu stavku</button>
    ...
    <div class="bg-white border-x sm:border-y sm:rounded shadow px-4 py-8 sm:p-8">
        ...
        <div class="md:flex">
            ...
            <div class="md:w-2/3 sm:flex">
                ...
                <div class="sm:w-1/2">
                    <input type="text" name="end_time" id="item_datetime_end" placeholder="kraj" class="w-full bg-grey-lighter mt-2 sm:mt-0 py-2 font-light text-center border rounded">
        ...
        <button class="reservation_equipment_submit_by_item sm:hidden cursor-pointer w-full bg-primary hover:bg-primary-dark text-white font-bold uppercase px-2 py-3 md:px-4 mt-6 border border-primary shadow rounded focus:outline-none">Rezerviši</button>
    </div>
    <!-- Button for desktop view -->
    <button class="reservation_equipment_submit_by_item hidden sm:block cursor-pointer w-full bg-primary hover:bg-primary-dark text-white font-bold uppercase px-2 py-3 md:px-4 mt-4 border border-primary shadow rounded focus:outline-none">Rezerviši</button>
</div>
    ...
    <div class="fixed pin z-50 overflow-auto bg-smoke-light flex items-center">
        <div id="modal-content" class="p-8 bg-white w-full max-w-sm m-auto flex-col flex rounded shadow">
            ...
            <div class="flex flex-inline justify-between">
                <button type="button" class="bg-red hover:bg-red-dark text-white font-medium w-full py-2 mt-2 mr-2 border border-red-light rounded focus:outline-none" id="reservation_equipment_submit_by_item_modal-btn-yes">Potvrdi</button>
                <button type="button" class="bg-grey hover:bg-grey-dark text-grey-dark font-medium w-full py-2 mt-2 ml-2 border border-grey rounded focus:outline-none" id="reservation_equipment_submit_by_item_modal-btn-no">Otkaži</button>
            </div>
        </div>
    </div>
</div>
