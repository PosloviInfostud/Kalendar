<form id="update_equipment_form" class="mt-4">
    <h2 class="pl-2 font-normal text-lg xs:text-xl sm:text-2xl border-l-4 mb-8 border-indigo">Izmena podataka o opremi</h2>
    <input type="hidden" name="id" id="update_equipment_id" value="<?= $equipment['id'] ?>">
    <div class="mt-2 mb-8">
        <label for="Name" class="text-lg">Ime <small class="text-grey-dark text-sm">(obavezno)</small></label>
    ...
    <div class="mt-2 mb-8">
        <label for="type" class="text-lg">Vrsta opreme</label>
    ...
    <div class="mt-2 mb-8">
        <label for="Name" class="text-lg">Barkod <small class="text-grey-dark text-sm">(obavezno)</small></label>
