<div class="bg-white xs:rounded shadow">
    ...
    <div class="bg-grey-lightest px-5 py-5 xs:px-10 xs:py-10">
        ...
        <form id="login_form" data-section="login">
            ...
            <div class="flex">
                <input type="submit" id="login_submit" value="Prijavite se" class="cursor-pointer bg-primary hover:bg-primary-dark w-full p-4 text-sm text-white uppercase font-bold rounded">
            </div>
        </form>
        ...
        <form id="register_form" data-section="register" class="hidden">
            ...
            <div class="flex">
                <input type="submit" id="register_submit" value="Registrujte se" class="cursor-pointer bg-primary hover:bg-primary-dark w-full p-4 text-sm text-white uppercase font-bold rounded">
            </div>
        </form>
