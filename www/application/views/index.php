<div class="bg-white rounded shadow">
    ...
    <div class="bg-grey-lightest px-10 py-10">
        ...
        <form id="login_form" data-section="login">
            ...
            <div class="flex">
                <input type="submit" id="login_submit" value="Login" class="cursor-pointer bg-primary hover:bg-primary-dark w-full p-4 text-sm text-white uppercase font-bold tracking-wider">
            </div>
        </form>
        ...
        <form id="register_form" data-section="register" class="hidden">
            ...
            <div class="flex">
                <input type="submit" id="register_submit" value="Register" class="cursor-pointer bg-primary hover:bg-primary-dark w-full p-4 text-sm text-white uppercase font-bold tracking-wider">
            </div>
        </form>
        ...
        <form id="forgot_form" data-section="forgot" class="hidden">
            ...
            <div class="mb-6">
                <input type="email" name="email" id="forgot_email" class="border w-full p-3" placeholder="E-Mail">
                <small id="forgot_email_err" class="error_box text-xs text-red font-normal"></small>
            </div>
            <div class="flex">
                <input type="submit" id="forgot_submit" value="Send verification email" class="cursor-pointer bg-primary hover:bg-primary-dark w-full p-4 text-sm text-white uppercase font-bold tracking-wider">
            </div>
        </form>
    </div>
